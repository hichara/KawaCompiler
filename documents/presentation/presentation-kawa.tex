...
\begin{frame}{Conclusion}
  \begin{itemize}
    \item<1-> Nous allons commencer réalisation pendant le second semestre, tout en ce basant sur la première partie.
    \item<2-> Les documents seront constamment mis à jour durant cette phase de réalisation.
  \end{itemize}
