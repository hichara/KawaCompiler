...
int main()
{
	...
	vec1.clear();
	vec1.push_back(methParam1typeName);
	methtParam1Type->setTypeName(vec1);
	...
	vec1.clear();
	vec1.push_back(methtypeName);
	methtType->setTypeName(vec1);
	...
	prototype = new KT_Prototype;
	methode->setPrototype(prototype);
	...
	vec1.clear();
	vec1.push_back(constParam1typeName);
	constParam1Type->setTypeName(vec1);
	...
	vec1.clear();
	vec1.push_back(typeName2);	
	att2Type->setTypeName(vec1);
	...
	vec1.clear();
	vec1.push_back(typeName1);	
	att1Type->setTypeName(vec1);
